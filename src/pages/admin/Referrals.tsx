...
const AMBASSADOR_CODES: { code: string; name: string; institution: string }[] = [
    { code: "AMB-shahsawar", name: "Shah Sawar", institution: "NWSM" },
    { code: "AMB-habib", name: "Habib Ur Rahman", institution: "NWSM" },
    { code: "AMB-tashfeen", name: "Tashfeen Ahmad", institution: "NWSM" },
    { code: "AMB-zeeshan", name: "Zeeshan Ahmad", institution: "" },
    { code: "AMB-sundas", name: "Sundas Wahab", institution: "" },
    { code: "AMB-abdullah", name: "Abdullah", institution: "" },
    { code: "AMB-ubaid", name: "Ubaid Ur Rahman", institution: "" },
    { code: "AMB-asad", name: "Asad", institution: "" },
    { code: "AMB-saad", name: "Saad Khan", institution: "" },
    { code: "AMB-usman", name: "Usman Ghani", institution: "" },
    { code: "AMB-musa", name: "Muhammad Musa", institution: "" },
    { code: "AMB-abuzar", name: "Abuzar Ahmad", institution: "" },
    { code: "AMB-farhan", name: "Farhan Ullah", institution: "" },
    { code: "AMB-saifullah", name: "Saif Ullah", institution: "" },
    { code: "AMB-anees", name: "Anees Ur Rahman", institution: "" },
    { code: "AMB-ismail", name: "Ismail Khan", institution: "" },
    { code: "AMB-hussain", name: "Hussain Muhammad", institution: "" },
    { code: "AMB-shafi", name: "Shafi Ullah", institution: "" },
    { code: "AMB-neelam", name: "Neelam Gul", institution: "" },
    { code: "AMB-laiba", name: "Laiba Ilyas", institution: "" },
    { code: "AMB-afnan", name: "Afnan Waheed", institution: "" },
    { code: "AMB-aleeza", name: "Aleeza Danish", institution: "" },
    { code: "AMB-hania", name: "Hania Khan", institution: "" },
    { code: "AMB-samreen", name: "Samreen Wahab", institution: "" },
    { code: "AMB-imen", name: "Imen Noor", institution: "" },
    { code: "AMB-tooba", name: "Tooba Aziz", institution: "" },
    { code: "AMB-fazila", name: "Fazila", institution: "" },
    { code: "AMB-laraib", name: "Laraib Gul", institution: "" },
    { code: "AMB-rida", name: "Rida Noor", institution: "" },
    { code: "AMB-muneeza", name: "Muneeza", institution: "" },
    { code: "AMB-ramlah", name: "Ramlah", institution: "" },
    { code: "AMB-sawera", name: "Sawera", institution: "" },
    { code: "AMB-bisma", name: "Bisma", institution: "" },
    { code: "AMB-ayesha", name: "Ayesha Siddique", institution: "" },
    { code: "AMB-sidra", name: "Sidra Noor", institution: "" },
    { code: "AMB-noor", name: "Noor Ul Ain", institution: "" },
    { code: "AMB-hafsa", name: "Hafsa Khan", institution: "" },
    { code: "AMB-hira", name: "Hira Fatima", institution: "" },
    { code: "AMB-zainab", name: "Zainab", institution: "" },
    { code: "AMB-mehak", name: "Mehak", institution: "" },
    { code: "AMB-khadija", name: "Khadija Noor", institution: "" },
    { code: "AMB-maryam", name: "Maryam", institution: "" },
    { code: "AMB-amina", name: "Amina Khan", institution: "" },
    { code: "AMB-fatima", name: "Fatima Bibi", institution: "" },
    { code: "AMB-sarah", name: "Sarah", institution: "" },
    { code: "AMB-rabbia", name: "Rabbia", institution: "" },
    { code: "AMB-izzah", name: "Izzah", institution: "" },
    { code: "AMB-mahnoor", name: "Mahnoor", institution: "" },
    { code: "AMB-sana", name: "Sana", institution: "" },
    { code: "AMB-arooj", name: "Arooj", institution: "" },
    { code: "AMB-hamna", name: "Hamna", institution: "" },
    { code: "AMB-eman", name: "Eman", institution: "" },
    { code: "AMB-alina", name: "Alina", institution: "" },
];
